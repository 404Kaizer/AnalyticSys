...
function getSearchableFields(scope) {
  const map = {
    ...
    sap: ['usuario', 'movimento', 'ref', 'pedido', 'documento', 'central', 'deposito', 'dtDoc', 'dtLanc', 'dtReg', 'material', 'materialOriginal', 'peso', 'um', 'custoUnit', 'valorTotal'],
