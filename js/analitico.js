          ...
          <table>
            <thead>
              <tr>
                ...
                <th data-sort-col="4" data-sort-type="num" onclick="sortMicroTable(this,event)" title="Compra/recebimento e transferência entre centros (101, 801, 861/862, 301–306) — LÍQUIDO: estornos e transferências para fora entram como negativo e anulam o positivo que os originou. O ícone ao lado do valor indica se o total do SAP bate com o lançado na PUZL">Entradas ${_SORT_ICO}<br><span style="font-size:9px;font-weight:400;opacity:.7">(líq. por código)</span></th>
                <th data-sort-col="5" data-sort-type="num" onclick="sortMicroTable(this,event)" title="Consumo e seu estorno (201, 202). O ícone ao lado do valor indica se o total do SAP bate com o lançado na PUZL">Saídas ${_SORT_ICO}<br><span style="font-size:9px;font-weight:400;opacity:.7">(por código)</span></th>
