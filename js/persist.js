...
const saveSnapshotKeys = ['configs', 'filiais', 'materiais', 'gruposMateriais', 'entradas', 'saidas', 'lancamentos', 'sap', 'producao', 'imports', 'ocorrencias', 'acoesRelatorio', 'notifications', 'invJustificativas'];
