...
Cohesion: 0.11
Nodes (34): atualizarBarraLote(), _custosSapOutlierInfo(), _custosSapResolveMaterial(), _donoDisplay(), getGrupoSapPorCodigoIndex(), getMateriaisSemCadastroDoModulo(), initAusencias(), limparSelecaoLote() (+26 more)
...
### Community 111 - "adminAplicarEdicaoLote"
Cohesion: 0.25
...
## Knowledge Gaps
- **279 isolated node(s):** `ADMIN_MODULOS`, `_adminProfiles`, `_adminAuthInfo`, `_adminCurrentRows`, `_adminSelectedIds` (+274 more)
