...
## Summary
- 2071 nodes · 4247 edges · 113 communities (104 shown, 9 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 501 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `005cdd10`
...
Cohesion: 0.05
Nodes (89): _ADMIN_COL_TYPES, ADMIN_MODAL_PROPRIO, ADMIN_MODULOS, adminAbrirEdicao(), adminAbrirEdicaoLote(), adminAbrirExclusaoMassa(), adminAceitarPendente(), adminAceitarTodosPendentes() (+81 more)
...
### Community 17 - "_mesclarGrandeComBanco"
Cohesion: 0.14
Nodes (14): _custosSapFromDbRow(), _custosSapRealtimeInit(), _custosSapRemoveLocal(), _custosSapUpsertLocal(), _entradasFromDbRow(), _lancFromDbRow(), _mesclarGrandeComBanco(), _saidasFromDbRow() (+6 more)
...
### Community 101 - "_dgVgRenderChartGrupoMaterial"
Cohesion: 0.18
...
### Community 102 - "_custosSapSyncUpsert"
Cohesion: 0.29
...
### Community 112 - "_buildCentralOptionsHtml"
Cohesion: 0.50
...
- **Why does `openModal()` connect `openModal` to `analitico.js`, `format.js`?**
