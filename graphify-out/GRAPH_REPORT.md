...
## Corpus Check
- 50 files · ~299,574 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2070 nodes · 4241 edges · 110 communities (101 shown, 9 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 494 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `205f34e6`
...
Cohesion: 0.05
Nodes (90): _ADMIN_COL_TYPES, ADMIN_MODAL_PROPRIO, ADMIN_MODULOS, adminAbrirEdicao(), adminAbrirEdicaoLote(), adminAbrirExclusaoMassa(), adminAceitarPendente(), adminAceitarTodosPendentes() (+82 more)
...
Cohesion: 0.03
Nodes (57): abrirSemCadastroModuloModal(), _ausCollapsed, _ausFilter, buildEntradaColumnMap(), buildLancamentoColumnMap(), buildSaidaColumnMap(), buildSapColumnMap(), CODIGOS_SAIDA (+49 more)
...
Cohesion: 0.06
Nodes (44): Ocorrências 'Ordenar' Micro-filter (31/07), fmt(), fmtR(), _invApplyJustValues(), invAtualizarAlertas(), invAtualizarKpis(), _invAtualizarProgresso(), invAtualizarSemCadastro() (+36 more)
...
Cohesion: 0.10
Nodes (29): _buildCentralOptionsHtml(), _CASCADE_TABELAS_NUVEM, _cascadeRestoreCloudByImportId(), _criarRegistroEntrada(), _criarRegistroLancamento(), _criarRegistroSaida(), _criarRegistroSAP(), _custosSapManualPopularSelects() (+21 more)
...
Cohesion: 0.09
Nodes (14): _ausGetPeriodo(), _buildAusenciasRelHTML(), _buildRankingShellHTML(), _dgrCanvasParaPngDataUrl(), _dgrCapturarCategoriaAmpliada(), _dgrCapturarComTema(), _dgrFonteIconesEmbutida(), _dgrFontesEmbutidas() (+6 more)
...
Cohesion: 0.07
Nodes (38): CODIGOS_ENTRADA, _daBuildEntradasFlat(), _daBuildRanking(), _daBuildTabelaMaterial(), _daPesoMedioPorTipo(), _daRenderDetalhadoAnalitico(), _daVarIrrelevante(), DG_VG_CAT_ORDER (+30 more)

### Community 22 - "renderModule"
Cohesion: 0.11
Nodes (33): atualizarBarraLote(), _custosSapResolveMaterial(), _donoDisplay(), getGrupoSapPorCodigoIndex(), getMateriaisSemCadastroDoModulo(), initAusencias(), limparSelecaoLote(), _pendPadronizacaoBtnHtml() (+25 more)
...
Cohesion: 0.15
Nodes (20): _dcBuildRankingCentrais(), _dcBuildRankingMateriais(), _dcCalcGiroCoberturaGeral(), _dcRenderChartRanking(), _dcRenderKpiStrip(), _dgDeltaBadgeHtml(), _dgRankCardHtml(), _dgResolveCssColor() (+12 more)

### Community 27 - "escapeHtml"
Cohesion: 0.24
Nodes (12): buildAnaliticoDetailBreakdown(), buildAnaliticoDetailHtml(), escapeHtml(), findMaterialTransferPair(), findTransferPairCentral(), getMatTransferPairIndex(), getTransferPairIndex(), _matTransferPairKey() (+4 more)

### Community 28 - "cloud-backup.js"
Cohesion: 0.20
Nodes (18): Admin Health — Storage Tab (28/07), _cbBackupTodosModulos(), _cbGuardarGeracaoAnterior(), _cbGunzipBlob(), _cbGzipString(), _cbLastBackupAt, _cbLerGeracao(), _cbRestaurarModulo() (+10 more)
...
Cohesion: 0.13
Nodes (25): _abrirModalDetalheMaterial(), _abrirModalDetalheMaterialFromEl(), _agruparRegistros(), _applyModuleSort(), _bdmFechExcluidosHtml(), _buildResumoCardsHtml(), _convertNfPesoToKg(), _fecharModalDetalheMaterial() (+17 more)
...
### Community 40 - "_custosSapSyncUpsert"
Cohesion: 0.29
Nodes (7): _criarRegistroCustosSap(), _custosSapSyncDelete(), _custosSapSyncUpsert(), _custosSapSyncUpsertBatch(), _custosSapToDbRow(), excluirCustosSap(), salvarCustosSapManual()
...
Cohesion: 0.12
Nodes (22): _buildRankingCentraisBody(), _buildRankingRegionaisTableBlock(), _buildRankSideCard(), _dgrAbastInfo(), _dgrBuildCustoAbsolutoHtml(), _dgrBuildCustoRegionalCentralHtml(), _dgrBuildDetalhadoAnaliticoHtml(), _dgrBuildGiroCoberturaHtml() (+14 more)

### Community 45 - "_fechMgrGetTodosCandidatos"
Cohesion: 0.39
Nodes (9): _fechImportNormDoc(), _fechMesIndice(), _fechMgrGetTodosCandidatos(), _getFechOverrideSet(), _getInvJustDocSet(), getSapFechKey(), isSapDocJustificadoInventario(), isSapExcluidoPorFechamento() (+1 more)
...
### Community 63 - "_mesclarGrandeComBanco"
Cohesion: 0.22
...
### Community 76 - "_custosSapFromDbRow"
Cohesion: 0.40
...
### Community 88 - "excluirImportacao"
Cohesion: 0.33
...
## Knowledge Gaps
- **245 isolated node(s):** `_pageScrollPos`, `_somenteManuais`, `_SAP_REVERSE_MOVS`, `_moduleSortState`, `_colFilterPassCache` (+240 more)
...
- **Why does `CLOUD_BACKUP_MODULOS` connect `admin.js` to `excluirImportacao`, `cloud-backup.js`, `dashboard.js`, `renderModule`?**
  _High betweenness centrality (0.117) - this node is a cross-community bridge._
- **Why does `removerRegistro()` connect `renderModule` to `analitico.js`, `admin.js`, `dashboard.js`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **What connects `_pageScrollPos`, `_somenteManuais`, `_SAP_REVERSE_MOVS` to the rest of the system?**
...
- **Should `ui.js` be split into smaller, more focused modules?**
  _Cohesion score 0.03424657534246575 - nodes in this community are weakly interconnected._